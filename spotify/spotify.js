...
// `https://api.spotify.com/v1/search?q=${query}&type=${artist}` // artists: {items: [ id: "" ]}
// `https://api.spotify.com/v1/artists/${id}/related-artists` // artsists: []
